...
const currentSponsors: Sponsor[] = [
  ...
  },
  {
    ...
    desc: "FastSigns Downtown Calgary is a proud general sponsor of APEC. They provide high-quality signage, banners, and visual communications solutions for businesses across Calgary. Their expertise and community support make a real difference for organizations like APEC.",
    color: "border-[#94A3B8] bg-[#94A3B8]/5",
    badgeColor: "bg-[#94A3B8] text-white",
  },
];
