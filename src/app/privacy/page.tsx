  ...
  return (
    <div className="py-16 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-[#0f1f5c] mb-2">Privacy Policy</h1>
        <p className="text-sm text-gray-400 mb-8">Last updated: June 2026</p>

        <div className="prose prose-gray max-w-none space-y-8 text-gray-600 text-sm leading-relaxed">

          <section>
            <h2 className="text-lg font-bold text-[#0f1f5c] mb-2">1. Who We Are</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#0f1f5c] mb-2">2. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#0f1f5c] mb-2">3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#0f1f5c] mb-2">4. Information Sharing</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#0f1f5c] mb-2">5. Data Retention</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#0f1f5c] mb-2">6. Your Rights</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#0f1f5c] mb-2">7. Cookies</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#0f1f5c] mb-2">8. Security</h2>
