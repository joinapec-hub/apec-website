      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Info */}
            <div>
              <h2 className="text-3xl font-bold text-[#0f1f5c] mb-6">Contact Information</h2>
              <div className="space-y-5">
                <div className="flex gap-4 items-start">
                  <div className="w-10 h-10 rounded-lg bg-[#0f1f5c]/10 flex items-center justify-center text-[#0f1f5c] flex-shrink-0">
                  ...
                  <div>
                    <p className="font-semibold text-[#0f1f5c]">Head Office</p>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <a href="https://www.facebook.com/share/1BQ9gMnjL9/" target="_blank" rel="noopener noreferrer" className="block text-[#4A90D9] hover:underline text-sm">Follow us on Facebook →</a>
                    <a href="https://www.instagram.com/apecanada.ca" target="_blank" rel="noopener noreferrer" className="block text-[#4A90D9] hover:underline text-sm mt-1">Follow us on Instagram →</a>
                    <a href="https://www.facebook.com/groups/781259795220477/" target="_blank" rel="noopener noreferrer" className="block text-[#4A90D9] hover:underline text-sm mt-1">Join our Facebook Group →</a>
              ...
              <div className="mt-8 p-4 bg-[#F2E9D2] rounded-xl border border-[#C8A24B]/30 text-sm text-[#4a5a52]">
                <strong className="text-[#0f1f5c]">Important:</strong> APEC is not affiliated with or associated with any political party or government. We are a non-partisan, non-political voluntary professional organization.
              </div>
            </div>

            {/* Form */}
            <div>
              <h2 className="text-3xl font-bold text-[#0f1f5c] mb-6">Send a Message</h2>
              ...
              {status === "success" ? (
                <div className="rounded-xl bg-green-50 border border-green-200 p-8 text-center">
                  ...
                  <button onClick={() => { setStatus("idle"); setForm({ firstName: "", lastName: "", email: "", subject: "General Inquiry", message: "" }); }} className="mt-5 px-5 py-2 bg-[#0f1f5c] text-white rounded-lg text-sm font-medium hover:bg-[#0a1645] transition-colors">Send Another Message</button>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input name="firstName" value={form.firstName} onChange={handleChange} required type="text" className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0f1f5c] focus:border-[#0f1f5c]" placeholder="Jane" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-[#1D2621] mb-1">Last Name</label>
                      <input name="lastName" value={form.lastName} onChange={handleChange} required type="text" className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0f1f5c] focus:border-[#0f1f5c]" placeholder="Smith" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-[#1D2621] mb-1">Email</label>
                    <input name="email" value={form.email} onChange={handleChange} required type="email" className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0f1f5c] focus:border-[#0f1f5c]" placeholder="jane@example.com" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-[#1D2621] mb-1">Subject</label>
                    <select name="subject" value={form.subject} onChange={handleChange} className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0f1f5c] focus:border-[#0f1f5c] bg-white">
